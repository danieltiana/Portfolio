...
export default function Home() {
  return (
    <div
      className="relative min-h-[calc(100vh-7rem)] p-8 bg-gray-950"
      style={{ height: "100Vh" }}>
      ...
      <div className="relative flex flex-col md:flex-row items-center justify-center gap-20 h-full">
        <div className="flex flex-col gap-8 max-w-xl">
          <div className="space-y-2">
            <h2 className="text-6xl font-bold bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 text-transparent bg-clip-text [text-shadow:0_0_30px_rgba(59,130,246,0.2)]">
              Daniel Tiana
            </h2>
          ...
          <p className="text-md text-gray-400/80 leading-relaxed">
            Créer des expériences digitales avec des technologies de web
            moderne.Passioné de la création des applications fonctionnesls et
            design moderne
          </p>
        ...
        <div
          data-aos="fade-up"
          className="relative group md:-top-0"
          ...
          <div className="relative w-80 h-80 md:w-[32rem] md:h-[32rem]  sm:h-[100] rounded-3xl border-2 border-blue-500 overflow-hidden transition-transform duration-500 group-hover:scale-90">
            <img src={copy} alt="Profile" className="w-full object-cover" />
